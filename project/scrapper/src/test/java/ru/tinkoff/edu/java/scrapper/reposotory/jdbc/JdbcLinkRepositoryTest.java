...
//import static ru.tinkoff.edu.java.scrapper.reposotory.data.TestLinkData.stabEmptyResponse;
...
//        var request = new AddSubscriptionInput(tgChatId, url);
//
//        // when
...
//        var ex = assertThrows(AlreadySubscribedLinkException.class, () -> jdbcLinkRepository.add(request));
//
//
//        // then
