...
public class JooqTgChatRepositoryTest extends IntegrationEnvironment {
    ...
    @Autowired
    private JooqTgChatRepository jooqTgChatRepository;
    ...
    void testAddValidChat() {
        ...
        // when
        var tgChat = jooqTgChatRepository.save(request);
    ...
    void testDeleteValidChat() {
        ...
        // when
        var response = jooqTgChatRepository.remove(tgChatId);
    ...
    void testFindAll() {
        ...
        // when
        var response = jooqTgChatRepository.findAll();
    ...
    void testFindKnownChat() {
        ...
        // when
        var response = jooqTgChatRepository.findById(tgChatId);
