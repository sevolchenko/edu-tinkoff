...
public class JdbcSubscriptionRepositoryTest extends IntegrationEnvironment {
    ...
    void testAddValidSub() {
        ...
        // when
        var sub = jdbcSubscriptionRepository.save(request);
    ...
    void testDeleteValidSub() {
        ...
        // when
        var response = jdbcSubscriptionRepository.remove(request);
    ...
    void testFindAll() {
        ...
        // when
        var response = jdbcSubscriptionRepository.findAll();
    ...
    void testFindAllByLinkId1() {
        ...
        // when
        var response = jdbcSubscriptionRepository.findAllByLinkId(outputs.get(indexForCheck).getLinkId());
        ...
        assertThat(outputs.get(indexForCheck), is(equalTo(response.get(0))));
    ...
    void testFindAllByLinkId2() {
        ...
        // when
        var response = jdbcSubscriptionRepository.findAllByLinkId(linkId);
    ...
    void testFindKnownChat() {
        ...
        // when
        var response = jdbcSubscriptionRepository.findBySubscriptionId(request);
